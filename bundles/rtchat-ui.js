var RTChatUI = (function (exports) {
  ...
  class ChatBox extends HTMLElement {
    ...
    async _loadStyles() {
      try {
        ...
        const cssUrl = new URL('./chat-box.css', (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('rtchat-ui.js', document.baseURI).href)).href;
  ...
  exports.AudioStreamDisplay = AudioStreamDisplay;
  ...
  exports.NotificationSound = NotificationSound;
  exports.Peer = Peer;
  ...
  exports.VideoStreamDisplay = VideoStreamDisplay;
